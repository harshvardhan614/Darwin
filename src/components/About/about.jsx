...
export default function About() {
  ...
  return (
    <div className="flex items-center justify-center darwinAbout w-full max-w-7xl  my-[200px] z-20 mx-auto" data-aos="fade-up" id="about" style={{paddingTop:'20vh'}}>

      <img src={darwinPage} alt="no img" className="w-[580px] h-auto object-contain pb-[20px] " />

      <div className="flex flex-col items-start gap-[20px] darwinAboutDATA darwinAboutMain" >
        <div  className="w-auto darwinAboutHead ">
